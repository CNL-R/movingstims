...
ylabel('Hit Probability');
 %% II: Save Fig
 savedestination = 'C:\Users\Allenine\Documents\GitHub\movingstims\analysis\10108009\';
 participant = cond.subject{1};
 savefig(fig, strcat(savedestination, '\', participant, '_IETwo_raw.fig'));
 saveas(fig, strcat(savedestination, '\', participant, '_IETwo_raw.png'));
