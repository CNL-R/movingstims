%% Auditory Stimuli
intensities = [0 0.05 0.1 0.15 0.2 0.25 0.3 0.35 0.4];
...
for i = 1:size(intensities,2)
    amp = intensities(i);
    filename = ['aud_' num2str(intensities(i)*100) '.wav'];
    %%%%%%%%%%%
...
basedir = 'C:\Users\lhshaw\Desktop\movingstims\IESweep\stims';
for m = 1:size(intensities, 2)
    foldername = ['vis_' num2str(intensities(m)*100)];
